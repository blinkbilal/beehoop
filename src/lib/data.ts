...
export const services = [
  // ── Pillar 1: Strategic Advisory ─────────────────────────────────────────
  {
    ...
    pillar: 'advisory' as ServicePillar,
    description:
      'Crafting clear roadmaps and strategic priorities grounded in evidence — built for real-world execution, not the shelf.',
    longDescription: [
  ...
  },
  {
    ...
    pillar: 'advisory' as ServicePillar,
    description:
      'End-to-end M&A advisory — deal origination, commercial due diligence, negotiation, and post-merger integration — across borders, sectors, and complexity levels.',
    longDescription: [
  ...
  },
  {
    ...
    pillar: 'advisory' as ServicePillar,
    description:
      'Cohesive brand identity, market positioning, and go-to-market strategy — built on research, sharpened by creative insight, and measured by commercial impact.',
    longDescription: [
  ...
  },
  {
    ...
    pillar: 'advisory' as ServicePillar,
    description:
      'Rigorous financial modelling, performance analytics, and data-driven intelligence — giving leadership teams the confidence to act decisively in real time.',
    longDescription: [
  ...
  // ── Pillar 2: Data & Intelligence ─────────────────────────────────────────
  {
    ...
    pillar: 'intelligence' as ServicePillar,
    description:
      'Scalable, secure data pipelines that unify your disparate data streams into a single source of truth — engineered for reliability, observability, and growth.',
    longDescription: [
  ...
  },
  {
    ...
    pillar: 'intelligence' as ServicePillar,
    description:
      'Deploying advanced BI frameworks that transform static databases into dynamic, predictive intelligence — uncovering efficiencies and market opportunities.',
    longDescription: [
  ...
  },
  {
    ...
    pillar: 'intelligence' as ServicePillar,
    description:
      'Bespoke, real-time C-suite reporting dashboards that distill millions of data points into beautiful, actionable visual interfaces.',
    longDescription: [
  ...
  // ── Pillar 3: Digital Engineering ─────────────────────────────────────────
  {
    ...
    pillar: 'engineering' as ServicePillar,
    description:
      'Building bespoke software solutions — from enterprise platforms to proprietary tools — engineered for performance, scale, and long-term maintainability.',
    longDescription: [
  ...
  },
  {
    ...
    pillar: 'engineering' as ServicePillar,
    description:
      'Designing and engineering high-performance web applications and digital platforms that convert visitors into clients and scale with your growth.',
    longDescription: [
  ...
  },
  {
    ...
    pillar: 'engineering' as ServicePillar,
    description:
      'Connecting your technology stack — CRMs, ERPs, cloud platforms, and data sources — into a unified, automated operational backbone.',
    longDescription: [
...
export const testimonials = [
  ...
  {
    quote:
      'The brand strategy beehoop developed fundamentally changed how our stakeholders perceive us. Thorough, creative, and deeply aligned with our business objectives.',
    name: 'Group CEO',
  ...
  {
    quote:
      'We\'d been struggling to get usable intelligence from our data for years. beehoop\'s team built us a pipeline and BI architecture in weeks that our internal team had been trying to deliver for over a year. It genuinely changed how we operate.',
  ...
  {
    quote:
      'The custom software platform beehoop built for us is the best operational investment we\'ve made. It replaced three legacy tools, reduced our compliance overhead by 60%, and the code quality passed a rigorous third-party security audit.',
...
export const blogPosts = [
  {
    ...
    excerpt:
      'How leadership teams can build resilient strategies that adapt to disruption while maintaining strategic direction — and why five-year plans are no longer enough.',
    category: 'Strategy',
    date: '2026-02-15',
    readTime: '6 min read',
    content: [
  ...
  },
  {
    ...
    excerpt:
      'Lessons from over two decades of international deal-making on what separates successful transactions from costly failures.',
    category: 'M&A',
    date: '2026-01-28',
    readTime: '8 min read',
    content: [
  ...
  },
  {
    ...
    excerpt:
      'Why most analytics investments fail to deliver ROI — and a practical framework for building decision-grade intelligence that transforms operations.',
    category: 'Analytics',
    date: '2026-01-10',
    readTime: '5 min read',
    content: [
  ...
  },
  {
    ...
    excerpt:
      'The architectural decisions that separate data pipelines that crumble under growth from those that become a durable competitive infrastructure asset.',
  ...
  },
  {
    ...
    excerpt:
      'A decision framework used by engineering leaders to assess when to build, when to buy, and when an off-the-shelf tool is actually the competitive liability.',
  ...
  },
  {
    ...
    excerpt:
      'A practitioner\'s guide to the tools, architectures, and organisational practices that separate BI programmes that drive decisions from those that produce ignored dashboards.',
