    ...
    <section ref={sectionRef} className="bg-background-cream py-24 md:py-32">
      <div className="max-w-4xl mx-auto px-6 md:px-10 lg:px-20">
        ...
        >
          ...
          <span className="absolute -top-8 left-0 md:-left-8 font-syne text-[80px] md:text-[120px] leading-none text-accent-pale select-none pointer-events-none" aria-hidden="true">
            &ldquo;
          </span>
          ...
          <div className="relative min-h-[200px]" aria-live="polite" aria-atomic="true">
            <AnimatePresence mode="wait">
              ...
              >
                <p className="font-syne text-2xl md:text-3xl text-text-primary italic leading-relaxed font-medium">
